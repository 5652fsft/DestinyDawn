...
const DATA = {
	...
	"seele":     {"name":"希儿",    "hp":65,  "move":6, "atk":18, "range":1,
		"skill":"相位突进", "skill_desc":"瞬移至 10 格范围内选定的敌方单体目标旁，并对目标造成 120%攻击力 的伤害", "skill_cd":3,
		"passive":"暗影突袭", "passive_desc":"攻击满血敌人时伤害 +50%"},
	"elaina":    {"name":"伊蕾娜",  "hp":60,  "move":5, "atk":20, "range":3,
		"skill":"星尘爆裂", "skill_desc":"对 6 格范围内目标及周围 1 格敌人造成 125%攻击力 的伤害", "skill_cd":4,
		"passive":"魔力共鸣", "passive_desc":"使用攻击/减益卡牌时，获得一层 [魔力充盈]，效果为攻击力 +15%，持续 2 回合，最多可叠加 3 层"},
	"firefly":   {"name":"流萤",    "hp":85,  "move":5, "atk":14, "range":1,
		"skill":"烈焰冲锋", "skill_desc":"对 6 格范围内目标造成 180%攻击力 的伤害并附加灼烧 2 回合", "skill_cd":3,
	...
	"karrigan":    {"name":"karrigan", "hp":65,  "move":9, "atk":10, "range":6,
		...
		"passive":"倒霉·混烟致残", "passive_desc":"karrigan 在场时，友方全体获得 [拧绳]，效果为受到攻击时 karrigan 分摊 30% 伤害。karrigan 死亡后移除友方所有 [拧绳]，剩余友方下回合获得一次额外行动和 [传承]，效果为攻击力 +50%"},
	"zephyr":      {"name":"Zephyr", "hp":85,  "move":5, "atk":8, "range":3,
		"skill":"引煞赴烬", "skill_desc":"降低当前 20% 血量，获得一层 [攀升]，效果为受到伤害 -10%，持续两回合，最多两层。不消耗行动次数", "skill_cd":0,
	...
	"M1DorG":    {"name":"M1DorG", "hp":72,  "move":6, "atk":11, "range":1,
		...
		"passive":"Intel工程师", "passive_desc":"对敌方目标释放攻击后，若没有造成击杀，移除我方随机 1 名角色的随机 1 个负面效果，并使其恢复 10 点生命值"},
